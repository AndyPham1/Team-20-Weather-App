...
public class WeatherFrame extends JFrame implements ActionListener {
	...
	public WeatherFrame() throws IOException {
        ...
        /* Weather pane for switching beween Earth and Mars weather */
		...
		tabbedWeatherPane.addTab("Mars", null, panel_1, null);
		tabbedWeatherPane.setBackgroundAt(1, new Color(255,0,0));
		
		JPanel panel_2 = new JPanel();
		panel_2.setLayout(null);
		panel_2.setBackground(new Color(255, 69, 0));
		panel_2.setBounds(0, 0, 626, 578);
		panel_1.add(panel_2);
		
		JLabel label = new JLabel("<dynamic>, <dynamic>");
		label.setHorizontalAlignment(SwingConstants.LEFT);
		label.setFont(new Font("Dialog", Font.PLAIN, 22));
		label.setBounds(10, 11, 400, 24);
		panel_2.add(label);
		
		JLabel label_3 = new JLabel("Conditions: <dynamic>");
		label_3.setFont(new Font("Tahoma", Font.PLAIN, 14));
		label_3.setBounds(10, 151, 400, 24);
		panel_2.add(label_3);
		
		JLabel label_4 = new JLabel((Icon) null);
		label_4.setBounds(10, 47, 75, 75);
		panel_2.add(label_4);
		
		JLabel label_5 = new JLabel("Weather Conditions");
		label_5.setFont(new Font("Dialog", Font.PLAIN, 18));
		label_5.setBounds(10, 127, 250, 24);
		panel_2.add(label_5);
		
		JLabel label_6 = new JLabel("Humidity: 0.0%\r\n");
		label_6.setFont(new Font("Tahoma", Font.PLAIN, 14));
		label_6.setBounds(10, 220, 170, 24);
		panel_2.add(label_6);
		
		JLabel label_7 = new JLabel("Wind Speed: <dynamic> km/h\r\n");
		label_7.setFont(new Font("Tahoma", Font.PLAIN, 14));
		label_7.setBounds(10, 174, 170, 24);
		panel_2.add(label_7);
		
		JLabel label_8 = new JLabel("Wind Direction: <dynamic>");
		label_8.setFont(new Font("Tahoma", Font.PLAIN, 14));
		label_8.setBounds(10, 198, 200, 24);
		panel_2.add(label_8);
		
		JLabel label_9 = new JLabel("Pressure: <dynamic> kPa\r\n");
		label_9.setFont(new Font("Tahoma", Font.PLAIN, 14));
		label_9.setBounds(10, 244, 150, 24);
		panel_2.add(label_9);
		
		JLabel label_10 = new JLabel("Current Temperature: ");
		label_10.setBounds(330, 22, 183, 50);
		panel_2.add(label_10);
		
		JLabel label_11 = new JLabel("<dynamic>\u00B0");
		label_11.setFont(new Font("Tahoma", Font.PLAIN, 56));
		label_11.setBounds(330, 46, 250, 68);
		panel_2.add(label_11);
		
		JLabel label_12 = new JLabel("\u2207<dynamic>\u00B0");
		label_12.setBounds(397, 125, 60, 15);
		panel_2.add(label_12);
		
		JLabel label_13 = new JLabel("\u25B2<dynamic>\u00B0");
		label_13.setBounds(330, 125, 60, 14);
		panel_2.add(label_13);
		
		JLabel label_14 = new JLabel("Last updated: <dynamic>");
		label_14.setBounds(384, 251, 220, 14);
		panel_2.add(label_14);
		
		JButton button = new JButton();
		button.setContentAreaFilled(false);
		button.setBounds(561, 11, 40, 40);
		panel_2.add(button);
	...
	public void refreshGUI() {
		...
		currLocationLabel.setText(weatherData.getCurrentWeather().getCurrentCity() + ", "
                + weatherData.getCurrentWeather().getCountryCode());
		currSunriseLabel.setText("Sunrise: "
				+ weatherData.getCurrentWeather().getSunrise());
		currSunsetLabel.setText("Sunset: "
				+ weatherData.getCurrentWeather().getSunset());
		currWeatherConditionLabel.setText("Weather Conditions");
		currHumidityLabel.setText("Humidity: "
				+ weatherData.getCurrentWeather().getHumidity() + "%\r\n");
		currWindSpeedLabel.setText("Wind Speed: "
				+ df.format(weatherData.getCurrentWeather().getWindSpeed()) + " km/h\r\n");
		currWindDirection.setText("Wind Direction: "
				+ weatherData.getCurrentWeather().getWindDirectionString());
		currPressureLabel.setText("Pressure: "
				+ df.format(weatherData.getCurrentWeather().getAirPressure()) + " kPa\r\n");
		currTempOutput.setText(df.format(weatherData.getCurrentWeather()
				.getTemperature()) + "\u00B0");
		currLowestTemp.setText("\u2207"
				+ df.format(weatherData.getCurrentWeather().getMinTemp()) + "\u00B0");
		currHighestTemp.setText("\u25B2"
				+ df.format(weatherData.getCurrentWeather().getMaxTemp()) + "\u00B0");
		lastUpdatedLabel.setText("Last updated: "
				+ weatherData.getCurrentWeather().getLastUpdatedTime());
		currWeatherDescriptionLabel.setText("Conditions: "
				+ weatherData.getCurrentWeather().getDescription());
		currWeatherIcon.setIcon(new ImageIcon(displayCorrectImage(weatherData
				.getCurrentWeather().getIcon())));
		longTermIcon1.setIcon(new ImageIcon(
				displayCorrectImage(weatherData.longTermWeather[0].getIcon())));
		longWeatherCondition1.setText(weatherData.longTermWeather[0]
				.getCondition());
		longTermTemp1.setText(df.format(weatherData.longTermWeather[0]
				.getTemperature()) + "\u00B0");
		longMaxTemp1.setText("\u25B2"
				+ df.format(weatherData.longTermWeather[0].getMax()));
		longMinTemp1.setText("\u2207"
				+ df.format(weatherData.longTermWeather[0].getMin()));
		longTermIcon2.setIcon(new ImageIcon(
				displayCorrectImage(weatherData.longTermWeather[1].getIcon())));
		longWeatherCondition2.setText(weatherData.longTermWeather[1]
				.getCondition());
		longTermTemp2.setText(df.format(weatherData.longTermWeather[1]
				.getTemperature()) + "\u00B0");
		longMaxTemp2.setText("\u25B2"
				+ df.format(weatherData.longTermWeather[1].getMax()));
		longMinTemp2.setText("\u2207"
				+ df.format(weatherData.longTermWeather[1].getMin()));
		longTermIcon3.setIcon(new ImageIcon(
				displayCorrectImage(weatherData.longTermWeather[2].getIcon())));
		longWeatherCondition3.setText(weatherData.longTermWeather[2]
				.getCondition());
		longTermTemp3.setText(df.format(weatherData.longTermWeather[2]
				.getTemperature()) + "\u00B0");
		longMaxTemp3.setText("\u25B2"
				+ df.format(weatherData.longTermWeather[2].getMax()));
		longMinTemp3.setText("\u2207"
				+ df.format(weatherData.longTermWeather[2].getMin()));
		longTermIcon4.setIcon(new ImageIcon(
				displayCorrectImage(weatherData.longTermWeather[3].getIcon())));
		longWeatherCondition4.setText(weatherData.longTermWeather[3]
				.getCondition());
		longTermTemp4.setText(df.format(weatherData.longTermWeather[3]
				.getTemperature()) + "\u00B0");
		longMaxTemp4.setText("\u25B2"
				+ df.format(weatherData.longTermWeather[3].getMax()));
		longMinTemp4.setText("\u2207"
				+ df.format(weatherData.longTermWeather[3].getMin()));
		longTermIcon5.setIcon(new ImageIcon(
				displayCorrectImage(weatherData.longTermWeather[4].getIcon())));
		longWeatherCondition5.setText(weatherData.longTermWeather[4]
				.getCondition());
		longTermTemp5.setText(df.format(weatherData.longTermWeather[4]
				.getTemperature()) + "\u00B0");
		longMaxTemp5.setText("\u25B2"
				+ df.format(weatherData.longTermWeather[4].getMax()));
		longMinTemp5.setText("\u2207"
				+ df.format(weatherData.longTermWeather[4].getMin()));
		shortTermIcon1.setIcon(new ImageIcon(
                displayCorrectImage(weatherData.shortTermWeather[0].getIcon())));
		shortTermTemp1.setText(df.format(weatherData.shortTermWeather[0]
				.getTemperature()) + "\u00B0");
		shortWeatherCondition1.setText(weatherData.shortTermWeather[0]
				.getCondition());
		shortTermIcon2.setIcon(new ImageIcon(displayCorrectImage(
                weatherData.shortTermWeather[1].getIcon())));
		shortTermTemp2.setText(df.format(weatherData.shortTermWeather[1]
				.getTemperature()) + "\u00B0");
		shortWeatherCondition2.setText(weatherData.shortTermWeather[1]
				.getCondition());
		shortTermIcon3.setIcon(new ImageIcon(
                displayCorrectImage(weatherData.shortTermWeather[2].getIcon())));
		shortTermTemp3.setText(df.format(weatherData.shortTermWeather[2]
				.getTemperature()) + "\u00B0");
		shortWeatherCondition3.setText(weatherData.shortTermWeather[2]
				.getCondition());
		shortTermIcon4.setIcon(new ImageIcon(
                displayCorrectImage(weatherData.shortTermWeather[3].getIcon())));
		shortTermTemp4.setText(df.format(weatherData.shortTermWeather[3]
				.getTemperature()) + "\u00B0");
		shortWeatherCondition4.setText(weatherData.shortTermWeather[3]
				.getCondition());
		shortTermIcon5.setIcon(new ImageIcon(
                displayCorrectImage(weatherData.shortTermWeather[4].getIcon())));
		shortTermTemp5.setText(df.format(weatherData.shortTermWeather[4]
				.getTemperature()) + "\u00B0");
		shortWeatherCondition5.setText(weatherData.shortTermWeather[4]
				.getCondition());
		shortTermIcon6.setIcon(new ImageIcon(
                displayCorrectImage(weatherData.shortTermWeather[5].getIcon())));
		shortTermTemp6.setText(df.format(weatherData.shortTermWeather[5]
				.getTemperature()) + "\u00B0");
		shortWeatherCondition6.setText(weatherData.shortTermWeather[5]
				.getCondition());
		shortTermIcon7.setIcon(new ImageIcon(
                displayCorrectImage(weatherData.shortTermWeather[6].getIcon())));
		shortTermTemp7.setText(df.format(weatherData.shortTermWeather[6]
				.getTemperature()) + "\u00B0");
		shortWeatherCondition7.setText(weatherData.shortTermWeather[6]
				.getCondition());
		shortTermIcon8.setIcon(new ImageIcon(
                displayCorrectImage(weatherData.shortTermWeather[7].getIcon())));
		shortTermTemp8.setText(df.format(weatherData.shortTermWeather[7]
				.getTemperature()) + "\u00B0");
		shortWeatherCondition8.setText(weatherData.shortTermWeather[7]
				.getCondition());
	}
}
