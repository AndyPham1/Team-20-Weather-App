...
public class WeatherFrame extends JFrame implements ActionListener {
	...
	/* Instance Variables */
    //PICTURES
    private BufferedImage myPictureSunny = ImageIO.read(this.getClass().getClassLoader().getResourceAsStream("sunny.png"));
    private BufferedImage myPictureCloudy = ImageIO.read(this.getClass().getClassLoader().getResourceAsStream("cloudy.png"));
    private BufferedImage myPictureDrizzle = ImageIO.read(this.getClass().getClassLoader().getResourceAsStream("drizzle.png"));
...
//        panel_1.add(lblSunset);
        ...
        this.updateCurrWeatherData(currWeatherPanel);
        		...
        		btnAccept.addActionListener(
        				new ActionListener() {
							public void actionPerformed(ActionEvent e) {
        						...
        						userCountryInput = convertToCountry(userCountryInput);
...
//        LocationPanel.add(btnRemove);
	...
	public String convertToCountry(String country) {
			String test = country.replaceAll(" ", "-");
			return test;
	}
	
	
	/**
	 * When a user presses the add button this method adds the country into the list
	...
	/**
	 * If there have been too many adds to the list, it will increment the list
	 * @param newWeatherData
	 */
	...
	public void updateCurrWeatherData(JPanel currWeatherPanel) {
        ...
        currRefreshButton.addActionListener(
        		new ActionListener() {
        			public void actionPerformed(ActionEvent e) {
        				...
        				updateCurrWeatherData(currWeatherPanel);
        				lastUpdatedLabel.setText("DONE");
        			}
        		});
	}
